...
var format_AGUA_RESIDUAL_4 = new ol.format.GeoJSON();
var features_AGUA_RESIDUAL_4 = format_AGUA_RESIDUAL_4.readFeatures(json_AGUA_RESIDUAL_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AGUA_RESIDUAL_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AGUA_RESIDUAL_4.addFeatures(features_AGUA_RESIDUAL_4);
var lyr_AGUA_RESIDUAL_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_AGUA_RESIDUAL_4, 
                style: style_AGUA_RESIDUAL_4,
                interactive: true,
                title: '<img src="styles/legend/AGUA_RESIDUAL_4.png" /> AGUA_RESIDUAL'
            });
...
lyr_StamenTerrain_0.setVisible(true);lyr_Gmaps_1.setVisible(true);lyr_MUNICIPIOSVE_2.setVisible(true);lyr_ESTADOSVE_3.setVisible(true);lyr_AGUA_RESIDUAL_4.setVisible(true);lyr_AduccinPaoCachinche_5.setVisible(true);lyr_AduccinPaoLaBalsa_6.setVisible(true);lyr_Estanques_7.setVisible(true);lyr_tuberia_8.setVisible(true);lyr_PTAR_9.setVisible(true);
var layersList = [lyr_StamenTerrain_0,lyr_Gmaps_1,lyr_MUNICIPIOSVE_2,lyr_ESTADOSVE_3,lyr_AGUA_RESIDUAL_4,lyr_AduccinPaoCachinche_5,lyr_AduccinPaoLaBalsa_6,lyr_Estanques_7,lyr_tuberia_8,lyr_PTAR_9];
...
lyr_AGUA_RESIDUAL_4.set('fieldAliases', {'UserId': 'UserId', 'FNODE_': 'FNODE_', 'TNODE_': 'TNODE_', 'LPOLY_': 'LPOLY_', 'RPOLY_': 'RPOLY_', 'LENGTH': 'LENGTH', 'AGUAS_RESI': 'AGUAS_RESI', 'AGUAS_RE_1': 'AGUAS_RE_1', });
...
lyr_AGUA_RESIDUAL_4.set('fieldImages', {'UserId': 'TextEdit', 'FNODE_': 'TextEdit', 'TNODE_': 'TextEdit', 'LPOLY_': 'TextEdit', 'RPOLY_': 'TextEdit', 'LENGTH': 'TextEdit', 'AGUAS_RESI': 'Range', 'AGUAS_RE_1': 'Range', });
...
lyr_AGUA_RESIDUAL_4.set('fieldLabels', {'UserId': 'no label', 'FNODE_': 'no label', 'TNODE_': 'no label', 'LPOLY_': 'no label', 'RPOLY_': 'no label', 'LENGTH': 'no label', 'AGUAS_RESI': 'no label', 'AGUAS_RE_1': 'no label', });
...
lyr_Estanques_7.set('fieldLabels', {'id': 'no label', 'codtGDS': 'no label', 'nombre_tq': 'header label', });
lyr_tuberia_8.set('fieldLabels', {'id': 'no label', 'codtGDS': 'no label', 'ID_SIST': 'header label', });
lyr_PTAR_9.set('fieldLabels', {'id': 'no label', 'Nombre': 'no label', 'TIPO': 'inline label', });
